...
/// <summary>
/// Sistema de transparencia de paredes para CINEMACHINE en SINGLEPLAYER
/// Usar en: Cinemachine Virtual Camera
/// Requiere: Asignar player manualmente en el Inspector
/// </summary>
public class TransparentarParedesSingleplayer : MonoBehaviour
{
    public GameObject player; // Asignar manualmente en Inspector
